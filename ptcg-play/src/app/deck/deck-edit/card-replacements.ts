...
export const exportReplacements = [
  ...
  //RS
  { from: 'Skitty RS2 44', to: 'Skitty RS 44' },
  ...
  //JTG
  { from: 'MaractusIR JTG 160', to: 'Maractus JTG 160' },
  { from: 'WailordIR JTG 162', to: 'Wailord JTG 162' },
  { from: 'Iono\'s KilowattrelIR JTG 163', to: 'Iono\'s Kilowattrel JTG 163' },
  { from: 'Lillie\'s RibombeeIR JTG 164', to: 'Lillie\'s Ribombee JTG 164' },
  { from: 'SwinubIR JTG 165', to: 'Swinub JTG 165' },
  { from: 'LycanrocIR JTG 166', to: 'Lycanroc JTG 166' },
  { from: 'N\'s ZoruaIR JTG 100', to: 'N\'s Zorua JTG 100' },
  { from: 'N\'s ReshiramIR JTG 167', to: 'N\'s Reshiram JTG 167' },
  { from: 'Hop\'s WoolooIR JTG 170', to: 'Hop\'s Wooloo JTG 170' },
  { from: 'Volcanion exFA JTG 171', to: 'Volcanion ex JTG 171' },
  { from: 'Iono\'s Bellibolt exFA JTG 172', to: 'Iono\'s Bellibolt ex JTG 172' },
  { from: 'Lillie\'s Clefairy exFA JTG 173', to: 'Lillie\'s Clefairy ex JTG 173' },
  { from: 'Mamoswine exFA JTG 174', to: 'Mamoswine ex JTG 174' },
  { from: 'N\'s Zoroark exFA JTG 175', to: 'N\'s Zoroark ex JTG 175' },
  { from: 'Hop\'s Zacian exFA JTG 176', to: 'Hop\'s Zacian ex JTG 176' },
  { from: 'Salamence exFA JTG 177', to: 'Salamence ex JTG 177' },
  { from: 'Dudunsparce exFA JTG 178', to: 'Dudunsparce ex JTG 178' },
  { from: 'Brock\'s Scouting JTG 179', to: 'Brock\'s Recruitment JTG 179' },
  { from: 'Iris\'s Fighting SpiritFA JTG 180', to: 'Iris\'s Fighting Spirit JTG 180' },
  { from: 'RuffianFA JTG 181', to: 'Ruffian JTG 181' },
  { from: 'Volcanion exSIR JTG 182', to: 'Volcanion ex JTG 182' },
  { from: 'Iono\'s Bellibolt exSIR JTG 183', to: 'Iono\'s Bellibolt ex JTG 183' },
  { from: 'Lillie\'s Clefairy exSIR JTG 184', to: 'Lillie\'s Clefairy ex JTG 184' },
  { from: 'N\'s Zoroark exSIR JTG 185', to: 'N\'s Zoroark ex JTG 185' },
  { from: 'Hop\'s Zacian exSIR JTG 186', to: 'Hop\'s Zacian ex JTG 186' },
  { from: 'Salamence exSIR JTG 187', to: 'Salamence ex JTG 187' },
  { from: 'Iono\'s Bellibolt exUR JTG 188', to: 'Iono\'s Bellibolt ex JTG 188' },
