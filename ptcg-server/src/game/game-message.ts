...
export enum GameLog {
  ...
  LOG_PLAYER_REFLIPS_WITH_BACKTRACK_BADGE = 'LOG_PLAYER_REFLIPS_WITH_BACKTRACK_BADGE', // { name }
  LOG_PLAYER_REFLIPS_WITH_TRICK_COIN = 'LOG_PLAYER_REFLIPS_WITH_TRICK_COIN', // { name }
