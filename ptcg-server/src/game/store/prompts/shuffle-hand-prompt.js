...
var ShuffleHandPrompt = /** @class */ (function (_super) {
    __extends(ShuffleHandPrompt, _super);
    function ShuffleHandPrompt(playerId) {
        var _this = _super.call(this, playerId) || this;
        _this.type = 'Shuffle deck';
        return _this;
    }
    ShuffleHandPrompt.prototype.validate = function (result, state) {
        var _this = this;
        if (result === null) {
            return false;
        }
