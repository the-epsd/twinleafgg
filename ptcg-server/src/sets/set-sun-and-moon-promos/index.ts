...
import { CelebiVenusaurGXSMP, DhelmiseSMP, EeveeSnorlaxGXSMP, EspeonDeoxysGXSMP, LucarioMelmetalGXSMP, LycanrocSMP, MagikarpWailordGXSMP, ReshiramCharizardGXSMP, UmbreonDarkraiGXSMP, VenusaurSnivyGXSMP } from './other-prints';
