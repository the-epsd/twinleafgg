...
export class GenesectEx2 extends PokemonCard {
  ...
  public fullName: string = 'Genesect-EX (FCO 120)';
  public legacyFullName = 'Genesect-EX FCO 120';

  public readonly DRIVE_CHANGE_MARKER = 'DRIVE_CHANGE_MARKER_2';
