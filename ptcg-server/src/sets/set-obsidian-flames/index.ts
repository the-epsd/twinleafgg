...
import { AbsolexArt, ArvenArt, BarboachArt, BelliboltArt, CharizardexArt, CharmanderArt, CharmeleonArt, CleffaArt, DragonairArt, DragoniteexArt, DratiniArt, EnteiArt, FinizenArt, LetterOfEncouragementArt, NinetalesArt, OddishArt, PalafinArt, PidgeotexArt, PidgeottoArt, PidgeyArt, PokemonLeagueHeadquartersArt, PoppyArt, RymeArt, ScizorArt, ThundurusArt, ToedscruelexArt, TownStoreArt, VaroomArt, VengefulPunchArt, WhiscashArt } from './card-images';
