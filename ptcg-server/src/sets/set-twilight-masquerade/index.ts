import { Dipplin3TWM, Poltchageist3TWM, Infernape2TWM, Froslass2TWM, Phione2TWM, Enamorus2TWM, HisuianGrowlithe2TWM, Timburr2TWM, Lairon2TWM, Applin3TWM, Tatsugiri2TWM, Chansey2TWM, Sinistchaex2TWM, TealMaskOgerponex2TWM, Magcargoex2TWM, HearthflameMaskOgerponex2TWM, Palafinex2TWM, WellspringMaskOgerponex2TWM, Luxrayex2TWM, IronThornsex2TWM, ScreamTailex2TWM, Greninjaex2TWM, CornerstoneMaskOgerponex2TWM, Dragapultex2TWM, Blisseyex2TWM, BloodmoonUrsalunaex2TWM, Caretaker2TWM, Carmine2TWM, Hassel2TWM, Kieran2TWM, LanasAssistance2TWM, Perrin2TWM, Sinistchaex3TWM, TealMaskOgerponex3TWM, HearthflameMaskOgerponex3TWM, WellspringMaskOgerponex3TWM, Greninjaex3TWM, CornerstoneMaskOgerponex3TWM, BloodmoonUrsalunaex3TWM, Carmine3TWM, Kieran3TWM, LanasAssistance3TWM, Perrin3TWM, TealMaskOgerponex4TWM, BloodmoonUrsalunaex4TWM, EnhancedHammer2TWM } from './other-prints';
...
export const setTwilightMasquerade: Card[] = [
  ...
  new Dipplin3TWM(),
  new Poltchageist3TWM(),
  new Infernape2TWM(),
  new Froslass2TWM(),
  new Phione2TWM(),
  new Enamorus2TWM(),
  new HisuianGrowlithe2TWM(),
  new Timburr2TWM(),
  new Lairon2TWM(),
  new Applin3TWM(),
  new Tatsugiri2TWM(),
  new Chansey2TWM(),
  new Sinistchaex2TWM(),
  new TealMaskOgerponex2TWM(),
  new Magcargoex2TWM(),
  new HearthflameMaskOgerponex2TWM(),
  new Palafinex2TWM(),
  new WellspringMaskOgerponex2TWM(),
  new Luxrayex2TWM(),
  new IronThornsex2TWM(),
  new ScreamTailex2TWM(),
  new Greninjaex2TWM(),
  new CornerstoneMaskOgerponex2TWM(),
  new Dragapultex2TWM(),
  new Blisseyex2TWM(),
  new BloodmoonUrsalunaex2TWM(),
  new Caretaker2TWM(),
  new Carmine2TWM(),
  new Hassel2TWM(),
  new Kieran2TWM(),
  new LanasAssistance2TWM(),
  new Perrin2TWM(),
  new Sinistchaex3TWM(),
  new TealMaskOgerponex3TWM(),
  new HearthflameMaskOgerponex3TWM(),
  new WellspringMaskOgerponex3TWM(),
  new Greninjaex3TWM(),
  new CornerstoneMaskOgerponex3TWM(),
  new BloodmoonUrsalunaex3TWM(),
  new Carmine3TWM(),
  new Kieran3TWM(),
  new LanasAssistance3TWM(),
  new Perrin3TWM(),
  new TealMaskOgerponex4TWM(),
  new BloodmoonUrsalunaex4TWM(),
  new EnhancedHammer2TWM(),
];
