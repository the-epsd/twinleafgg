...
import { Card, ChoosePokemonPrompt, GameError, PlayerType, PokemonCardList, SelectPrompt, SlotType, StateUtils } from '../../game';
import { DealDamageEffect } from '../../game/store/effects/attack-effects';

function* playCard(next: Function, store: StoreLike, state: State,
  self: Kieran, effect: TrainerEffect): IterableIterator<State> {
