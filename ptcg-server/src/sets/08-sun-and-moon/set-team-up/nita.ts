...
export class Nita extends TrainerCard {
  ...
  public text: string =
    "You can play this card only if your opponent's Active Pokémon is a Basic Pokémon. Put an Energy from your opponent's Active Pokémon on top of their deck. You may play only 1 Supporter card during your turn (before your attack).";
