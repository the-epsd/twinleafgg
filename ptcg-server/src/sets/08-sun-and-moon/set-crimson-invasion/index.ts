...
export const setCrimsonInvasion: Card[] = [
  ...
  new AlolanGolemGx2(),
  new NihilegoGx2(),
  new AlolanExeggutorGx2(),
  new OliviaCIN(),
  new GyaradosGx3(),
  new AlolanGolemGx3(),
  new NihilegoGx3(),
  new AlolanExeggutorGx3(),
];
