import { CardTag, CardTarget, CardType, ChoosePokemonPrompt, GameError, GameMessage, PlayerType, SlotType, State, StateUtils, StoreLike, TrainerCard, TrainerType } from "../../../game";
...
export class LifeForestPrismStar extends TrainerCard {
  ...
  public text: string = 'Once during each player\'s turn, that player may heal 60 damage and remove all Special Conditions from 1 of their [G] Pokémon.\n\nWhenever any player plays an Item or Supporter card from their hand, prevent all effects of that card done to this Stadium card.';
