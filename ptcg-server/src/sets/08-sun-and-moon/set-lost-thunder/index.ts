...
import { AlolanPersian } from './alolan-persian';
...
import { Cyndaquil2 } from './cyndaquil-2';
...
import { Kecleon2 } from './kecleon-2';
...
import { Mareanie2 } from './mareanie-2';
import { Mareep } from './mareep';
import { Mareep2 } from './mareep-2';
...
import { Unown2 } from './unown-2';
import { Unown3 } from './unown-3';
...
import { AetherFoundationEmployee } from './aether-foundation-employee';
...
import { FairyCharmDragon } from './fairy-charm-dragon';
...
import { MemoryEnergy } from './memory-energy';
...
import {
  ...
  MagcargoGX2LOT,
  BlacephalonGX2LOT,
  AlolanNinetalesGX2LOT,
  MimikyuGX2LOT,
  LugiaGX2LOT,
  Faba2LOT,
  JudgeULLOT,
  Mina2LOT,
  ProfessorElmLecture3LOT,
  ShuckleGX3LOT,
  MagcargoGX3LOT,
  BlacephalonGX3LOT,
  ZeraoraGX3LOT,
  AlolanNinetalesGX3LOT,
  MimikyuGX3LOT,
  LugiaGX3LOT,
  AdventureBag2LOT,
  CounterGain2LOT,
