...
import { AlolanMukGx } from './alolan-muk-gx';
...
import { Lycanroc2 } from './lycanroc-2';
...
import { MountLanakila } from './mount-lanakila';
import { Olivia } from './olivia';
import { Plumeria } from './plumeria';
import { PoTown } from './po-town';
import { RotomDexPokeFinderMode } from './rotom-dex-poke-finder-mode';
import { Sophocles } from './sophocles';
import { TormentingSpray } from './tormenting-spray';
...
export const setBurningShadows: Card[] = [
  ...
  new GardevoirGX3BUS(),
  new NoivernGX3BUS(),
  new BodybuildingDumbbells2BUS(),
  new ChoiceBandBUS(),
  new EscapeRopeBUS2BUS(),
  new SuperScoopUp2BUS(),
  new FireEnergyBUS(),
  new DarknessEnergyBUS(),
  new FairyEnergyBUS(),
  new TapuFiniGX2BUS(),
  new DarkraiGX2BUS(),
  new Acerola2BUS(),
