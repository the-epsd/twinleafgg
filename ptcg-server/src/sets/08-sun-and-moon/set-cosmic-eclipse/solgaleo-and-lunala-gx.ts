...
export class SolgaleoLunalaGX extends PokemonCard {
  ...
  public reduceEffect(store: StoreLike, state: State, effect: Effect): State {
    ...
    if (
      ...
      effect.player.marker.hasMarker(this.CLEAR_COSMIC_BURN_MARKER, this)
    ) {
    ...
    if (
      effect instanceof EndTurnEffect &&
      effect.player.active.marker.hasMarker(this.COSMIC_BURN_MARKER, this)
    ) {
    ...
    if (
      effect instanceof EndTurnEffect &&
      effect.player.marker.hasMarker(this.CLEAR_LIGHT_OF_THE_PROTECTOR_MARKER, this)
    ) {
    ...
    if (
      ...
      effect.opponent.marker.hasMarker(this.LIGHT_OF_THE_PROTECTOR_MARKER, this)
    ) {
