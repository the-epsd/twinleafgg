...
export class RaichuAlolanRaichuGX extends PokemonCard {
  ...
  public attacks = [
    ...
    },
    {
      ...
      damage: 150,
      text:
        " Switch this Pokémon with 1 of your Benched Pokémon. If this Pokémon has at least 2 extra [L] Energy attached to it (in addition to this attack's cost), this attack does 100 more damage." +
