...
import { StoreLike, State, StateUtils, GameMessage, PlayerType, SlotType, DamageMap } from '../../game';
...
export class Oricorio4 extends PokemonCard {
  ...
  public legacyFullName = 'Oricorio GRI 56';
