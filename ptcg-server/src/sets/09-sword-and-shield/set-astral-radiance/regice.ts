...
export class Regice extends PokemonCard {
  ...
  public reduceEffect(store: StoreLike, state: State, effect: Effect): State {
    ...
    if (
      ...
      if (
        (pokemonCard && pokemonCard.hasTag(CardTag.POKEMON_V)) ||
        (pokemonCard && pokemonCard.hasTag(CardTag.POKEMON_VSTAR)) ||
        (pokemonCard && pokemonCard.hasTag(CardTag.POKEMON_VMAX)) ||
        (pokemonCard && pokemonCard.hasTag(CardTag.POKEMON_VUNION))
      ) {
