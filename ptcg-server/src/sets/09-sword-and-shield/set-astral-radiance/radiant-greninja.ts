...
export class RadiantGreninja extends PokemonCard {
  ...
  public powers = [
    {
      ...
      text:
        'You must discard an Energy card from your hand in order ' +
  ...
  public attacks = [
    {
      ...
      damage: 0,
      text:
        'Discard 2 energy from this Pokémon. This attack does ' +
  ...
  public reduceEffect(store: StoreLike, state: State, effect: Effect): State {
    ...
    if (
      ...
      effect.player.marker.hasMarker(this.CONCEALED_CARDS_MARKER, this)
    ) {
      const player = effect.player;
      player.marker.removeMarker(this.CONCEALED_CARDS_MARKER, this);
    }
