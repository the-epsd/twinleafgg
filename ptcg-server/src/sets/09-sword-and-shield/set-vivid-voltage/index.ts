...
import { AlakazamV } from './alakazam-v';
...
import { CaraLiss } from './cara-liss';
import { CirchesterBath } from './circhester-bath';
import { DroneRotom } from './drone-rotom';
import { HerosMedal } from './heros-medal';
import { LeagueStaff } from './league-staff';
import { Leon } from './leon';
import { MemoryCapsule } from './memory-capsule';
import { MoomooCheese } from './moomoo-cheese';
import { Nessa } from './nessa';
import { Opal } from './opal';
import { TelescopicSight } from './telescopic-sight';
import { WyndonStadium } from './wyndon-stadium';
...
import {
  ...
  Nessa2,
  Opal2,
  PokemonCenterLadyVIV,
  OrbeetleVmax2,
  GalarianDarmanitanVmax2,
  PikachuVmax2,
  CoalossalVmax2,
  AegislashVmax2,
  TogekissVmax2,
...
export const setVividVoltage: Card[] = [
  ...
  new Forretress(),
  new TalonflameVFA(),
  new GalarianDarmanitanV(),
  new GalarianDarmanitanVmax(),
  new GalarianMeowth(),
  new GalarianPerrserker(),
  new GalarianSirfetchdV(),
  ...
  new Nessa2(),
  new Opal2(),
  new PokemonCenterLadyVIV(),
  new OrbeetleVmax2(),
  new GalarianDarmanitanVmax2(),
  new PikachuVmax2(),
  new CoalossalVmax2(),
  new AegislashVmax2(),
  new TogekissVmax2(),
