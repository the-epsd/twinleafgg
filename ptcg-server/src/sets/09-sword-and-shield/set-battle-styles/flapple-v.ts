...
export class FlappleV extends PokemonCard {
  ...
  public attacks = [
    {
      ...
      damage: 20,
      text:
        "During your opponent's next turn, the Defending Pokémon's " + 'attacks cost [C][C] more.',
    },
    {
      name: 'Wing Attack',
  ...
  public reduceEffect(store: StoreLike, state: State, effect: Effect): State {
    ...
    if (
      ...
      effect.player.active.marker.hasMarker(this.FLAPPLE_V_MARKER, this)
    ) {
    ...
    if (
      ...
      effect.player.marker.hasMarker(this.FLAPPLE_V_MARKER, this)
    ) {
