...
import { EarthenSealStone } from './earthen-seal-stone';
...
import { ProfessorLaventon } from './professor-laventon';
import { QuadStone } from './quad-stone';
...
export const setSilverTempest: Card[] = [
  ...
  new LugiaV3SIT(),
  new Candice2SIT(),
  new FurisodeGirl2SIT(),
  new Lance2SIT(),
  new Serena2SIT(),
  new Worker2SIT(),
  new SerperiorVSTAR2SIT(),
  new AlolanVulpixVSTAR2SIT(),
  new RegielekiVMAX2SIT(),
  new UnownVSTAR2SIT(),
  new RegidragoVSTAR2SIT(),
  new LugiaVSTAR2SIT(),
  new Candice3SIT(),
  new FurisodeGirl3SIT(),
  new Lance3SIT(),
  new Serena3SIT(),
  new Worker3SIT(),
  new SerperiorVSTAR3SIT(),
  new LugiaVSTAR3SIT(),
  new EnergySwitchPKSIT(),
  new GapejawBogSIT(),
  new LeafyCamoPoncho2SIT(),
  new VGuardEnergy2SIT(),
  new Braixen2SIT(),
  new FlaaffySIT(),
  new Gardevoir2SIT(),
  new DruddigonSIT(),
  ...
  new BlazikenVMAXSIT(),
  new RayquazaVMAXSIT(),
  new DuraludonVMAXSIT(),
  new BlisseyVSIT(),
  new JudgeULSIT(),
  new RaihanSIT(),
  new RayquazaVMAX2SIT(),
  new DuraludonVMAX2SIT(),
  new SandileSIT(),
  new MareanieSIT(),
  new MetangSIT(),
  new FletchlingSIT(),
