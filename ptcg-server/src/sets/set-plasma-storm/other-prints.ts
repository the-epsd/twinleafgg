...
export class EviolitePLS extends Eviolite {
  ...
  public fullName: string = 'Eviolite (PLS 122)';
  public legacyFullName = 'Eviolite PLS';
  public set = 'PLS';
}

export class VictiniEX2PLS extends VictiniEXPLS18 {
  public setNumber = '131';
  public fullName: string = 'Victini-EX (PLS 131)';
  public legacyFullName = 'Victini EX2 PLS';
  public set = 'PLS';
}

export class LugiaEx2PLS extends LugiaExPLS108 {
  public setNumber = '134';
  public fullName: string = 'Lugia-EX (PLS 134)';
  public legacyFullName = 'Lugia EX2 PLS';
  public set = 'PLS';
}

export class Colress2PLS extends ColressPLS118 {
  public setNumber = '135';
  public fullName: string = 'Colress (PLS 135)';
  public legacyFullName = 'Colress2 PLS';
  public set = 'PLS';
}

export class BlastoisePLS extends Blastoise {
  public setNumber = '137';
  public fullName: string = 'Blastoise (PLS 137)';
  public legacyFullName = 'Blastoise PLS';
  public set = 'PLS';
}

export class RandomReceiverPLS extends RandomReceiver {
  public setNumber = '138';
  public fullName: string = 'Random Receiver (PLS 138)';
  public legacyFullName = 'Random Receiver PLS';
  public set = 'PLS';
}
...
export class ArticunoEx2 extends ArticunoEx {
  ...
  public legacyFullName = 'Articuno-EX PLS 132';
}
...
export class CobalionEx2 extends CobalionEx {
  ...
  public legacyFullName = 'Cobalion-EX PLS 133';
}

export class CharizardPLS extends Charizard {
  public set: string = 'PLS';
  public setNumber: string = '136';
  public fullName: string = 'Charizard (PLS 136)';
  public legacyFullName = 'Charizard PLS';
}
