...
import { HereComesTeamRocket } from '../../03-ex-ruby-and-sapphire/set-ex-team-rocket-returns/here-comes-team-rocket';
...
export class DarknessEnergyEVO extends DarknessEnergy {
  public set = 'EVO';
  public setNumber = '97';
  public fullName = 'Darkness Energy EVO';
}
export class CaterpieEVO extends Caterpie {
  public setNumber = '3';
  public fullName: string = 'Caterpie EVO';
  public set = 'EVO';
}

export class MetapodEVO extends Metapod {
  public setNumber = '4';
  public fullName: string = 'Metapod EVO';
  public set = 'EVO';
}

export class WeedleEVO extends Weedle {
  public setNumber = '5';
  public fullName: string = 'Weedle EVO';
  public set = 'EVO';
}

export class EnergyRetrievalEVO extends EnergyRetrieval {
  public setNumber = '77';
  public fullName: string = 'Energy Retrieval EVO';
  public set = 'EVO';
}

export class FullHealEVO extends FullHeal {
  public setNumber = '78';
  public fullName: string = 'Full Heal EVO';
  public set = 'EVO';
}

export class MaintenanceEVO extends Maintenance {
  public setNumber = '79';
  public fullName: string = 'Maintenance EVO';
  public set = 'EVO';
}

export class PotionEVO extends Potion {
  public setNumber = '83';
  public fullName: string = 'Potion EVO';
  public set = 'EVO';
}

export class ReviveEVO extends Revive {
  public setNumber = '85';
  public fullName: string = 'Revive EVO';
  public set = 'EVO';
}

export class SuperPotionEVO extends SuperPotion {
  public setNumber = '87';
  public fullName: string = 'Super Potion EVO';
  public set = 'EVO';
}

export class SwitchEVO extends Switch {
  public setNumber = '88';
  public fullName: string = 'Switch EVO';
  public set = 'EVO';
}

export class DoubleColorlessEnergyEVO extends DoubleColorlessEnergy {
  public setNumber = '90';
  public fullName: string = 'Double Colorless Energy EVO';
  public set = 'EVO';
}

export class GrassEnergyEVO extends GrassEnergy {
  public setNumber = '91';
  public fullName: string = 'Grass Energy EVO';
  public set = 'EVO';
}

export class FireEnergyEVO extends FireEnergy {
  public setNumber = '92';
  public fullName: string = 'Fire Energy EVO';
  public set = 'EVO';
}

export class WaterEnergyEVO extends WaterEnergy {
  public setNumber = '93';
  public fullName: string = 'Water Energy EVO';
  public set = 'EVO';
}

export class LightningEnergyEVO extends LightningEnergy {
  public setNumber = '94';
  public fullName: string = 'Lightning Energy EVO';
  public set = 'EVO';
}

export class PsychicEnergyEVO extends PsychicEnergy {
  public setNumber = '95';
  public fullName: string = 'Psychic Energy EVO';
  public set = 'EVO';
}

export class FightingEnergyEVO extends FightingEnergy {
  public setNumber = '96';
  public fullName: string = 'Fighting Energy EVO';
  public set = 'EVO';
}

export class MetalEnergyEVO extends MetalEnergy {
  public setNumber = '98';
  public fullName: string = 'Metal Energy EVO';
  public set = 'EVO';
}

export class FairyEnergyEVO extends FairyEnergy {
  public setNumber = '99';
  public fullName: string = 'Fairy Energy EVO';
  public set = 'EVO';
}

export class DragoniteEX2EVO extends DragoniteEXEVO72 {
  public setNumber = '106';
  public fullName: string = 'Dragonite EX2 EVO';
  public set = 'EVO';
}

export class BrocksGrit2EVO extends BrocksGritEVO74 {
  public setNumber = '107';
  public fullName: string = 'Brock\'s Grit2 EVO';
  public set = 'EVO';
}
