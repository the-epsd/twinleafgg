import { PokemonCard, Stage, CardType, StoreLike, State, StateUtils, TrainerCard, TrainerType, ChooseCardsPrompt, GameMessage, SuperType, GameLog, CardTag } from "../../../game";
    ...
    if (WAS_ATTACK_USED(effect, 0, this)) {
      ...
      return store.prompt(state, new ChooseCardsPrompt(
        ...
        const cleanup = () => {
          ...
          const target = supporterCard.tags.includes(CardTag.PRISM_STAR)
            ? opponent.lostzone
            : opponent.discard;
