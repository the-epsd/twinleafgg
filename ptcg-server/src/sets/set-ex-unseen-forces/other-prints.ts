...
export class BoostEnergyUF extends BoostEnergy {
  public fullName = 'Boost Energy (UF 98)';
  public legacyFullName = 'Boost Energy UF';
  public set = 'UF';
  public setNumber = '98';
...
export class CycloneEnergyUF extends CycloneEnergy {
  public fullName = 'Cyclone Energy (UF 99)';
  public legacyFullName = 'Cyclone Energy UF';
  public set = 'UF';
  public setNumber = '99';
}

export class DarknessEnergySpecialUF extends DarknessEnergySpecial {
  public fullName = 'Darkness Energy (UF 96)';
  public legacyFullName = 'Darkness Energy Special UF';
  public set = 'UF';
  public setNumber = '96';
}

export class MetalEnergySpecialUF extends MetalEnergySpecial {
  public fullName = 'Metal Energy (UF 97)';
  public legacyFullName = 'Metal Energy Special UF';
  public set = 'UF';
  public setNumber = '97';
...
export class PokeBallUF extends PokeBall {
  public fullName = 'Poké Ball (UF 87)';
  public legacyFullName = 'Poké Ball UF';
  public set = 'UF';
  public setNumber = '87';
...
export class WarpEnergyUF extends WarpEnergy {
  public fullName = 'Warp Energy (UF 100)';
  public legacyFullName = 'Warp Energy UF';
  public set = 'UF';
...
export class WarpPointUF extends WarpPointMA {
  public fullName = 'Warp Point (UF 93)';
  public legacyFullName = 'Warp Point UF';
  public set = 'UF';
  public setNumber = '93';
}