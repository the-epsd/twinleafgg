...
export class JolteonStar extends PokemonCard {
  ...
  public reduceEffect(store: StoreLike, state: State, effect: Effect): State {
    if (
      ...
      !IS_POKEPOWER_BLOCKED(store, state, effect.player, this)
    ) {
    ...
    if (
      (effect instanceof PutDamageEffect || effect instanceof PutCountersEffect) &&
    ...
    if (
      ...
      HAS_MARKER(this.YELLOW_RAY_MARKER, effect.player, this)
    ) {
