import { BirdKeeper } from '../09-sword-and-shield/set-darkness-ablaze/bird-keeper';
import { Frosmoth } from '../09-sword-and-shield/set-sword-and-shield/frosmoth';
import { Rowlet } from '../09-sword-and-shield/set-darkness-ablaze/rowlet';
import { Grookey } from '../09-sword-and-shield/set-sword-and-shield/grookey';
import { Dottler } from '../09-sword-and-shield/set-sword-and-shield/dottler';
import { Eldegoss } from '../09-sword-and-shield/set-sword-and-shield/eldegoss';
import { Scorbunny } from '../09-sword-and-shield/set-sword-and-shield/scorbunny';
import { Suicune } from '../09-sword-and-shield/set-darkness-ablaze/suicune';
import { GalarianDarumaka } from '../09-sword-and-shield/set-rebel-clash/galarian-darumaka';
import { GalarianDarmanitan } from '../09-sword-and-shield/set-rebel-clash/galarian-darmanitan';
import { Drednaw } from '../09-sword-and-shield/set-sword-and-shield/drednaw';
import { Cramorant } from '../09-sword-and-shield/set-rebel-clash/cramorant';
import { Arctovish } from '../09-sword-and-shield/set-darkness-ablaze/arctovish';
import { Yamper } from '../09-sword-and-shield/set-sword-and-shield/yamper';
import { Boltund } from '../09-sword-and-shield/set-sword-and-shield/boltund';
import { Toxtricity } from '../09-sword-and-shield/set-darkness-ablaze/toxtricity';
import { Pincurchin } from '../09-sword-and-shield/set-sword-and-shield/pincurchin';
import { Morpeko } from '../09-sword-and-shield/set-rebel-clash/morpeko';
import { Dracozolt } from '../09-sword-and-shield/set-darkness-ablaze/dracozolt';
import { GalarianPonyta } from '../09-sword-and-shield/set-sword-and-shield/galarian-ponyta';
import { GalarianCorsola } from '../09-sword-and-shield/set-rebel-clash/galarian-corsola';
import { Dedenne } from '../09-sword-and-shield/set-darkness-ablaze/dedenne';
import { Polteageist } from '../09-sword-and-shield/set-darkness-ablaze/polteageist';
import { Hatenna } from '../09-sword-and-shield/set-rebel-clash/hatenna';
import { Hattrem } from '../09-sword-and-shield/set-rebel-clash/hattrem';
import { Milcery } from '../09-sword-and-shield/set-rebel-clash/milcery';
import { Alcremie } from '../09-sword-and-shield/set-rebel-clash/alcremie';
import { Indeedee } from '../09-sword-and-shield/set-rebel-clash/indeedee';
import { Dreepy } from '../09-sword-and-shield/set-rebel-clash/dreepy';
import { Drakloak } from '../09-sword-and-shield/set-rebel-clash/drakloak';
import { GalarianFarfetchd } from '../09-sword-and-shield/set-rebel-clash/galarian-farfetchd';
import { GalarianSirfetchd } from '../09-sword-and-shield/set-rebel-clash/galarian-sirfetchd';
import { GalarianYamask } from '../09-sword-and-shield/set-rebel-clash/galarian-yamask';
import { GalarianRunerigus } from '../09-sword-and-shield/set-rebel-clash/galarian-runerigus';
import { Silicobra } from '../09-sword-and-shield/set-sword-and-shield/silicobra';
import { Sandaconda } from '../09-sword-and-shield/set-sword-and-shield/sandaconda';
import { Clobbopus } from '../09-sword-and-shield/set-sword-and-shield/clobbopus';
import { Grapploct } from '../09-sword-and-shield/set-sword-and-shield/grapploct';
import { Stonjourner } from '../09-sword-and-shield/set-rebel-clash/stonjourner';
import { GalarianLinoone } from '../09-sword-and-shield/set-sword-and-shield/galarian-linoone';
import { Nickit } from '../09-sword-and-shield/set-sword-and-shield/nickit';
import { Thievul } from '../09-sword-and-shield/set-sword-and-shield/thievul';
import { Morgrem } from '../09-sword-and-shield/set-rebel-clash/morgrem';
import { Corviknight } from '../09-sword-and-shield/set-sword-and-shield/corviknight';
import { Duraludon } from '../09-sword-and-shield/set-rebel-clash/duraludon';
import { Minccino } from '../09-sword-and-shield/set-sword-and-shield/minccino';
import { Swanna } from '../09-sword-and-shield/set-darkness-ablaze/swanna';
import { Bunnelby } from '../09-sword-and-shield/set-darkness-ablaze/bunnelby';
import { Corvisquire } from '../09-sword-and-shield/set-sword-and-shield/corvisquire';
import { Wooloo } from '../09-sword-and-shield/set-sword-and-shield/wooloo';
import { Dubwool } from '../09-sword-and-shield/set-sword-and-shield/dubwool';
import { RillaboomV } from '../09-sword-and-shield/set-rebel-clash/rillaboom-v';
import { RillaboomVmax } from '../09-sword-and-shield/set-rebel-clash/rillaboom-vmax';
import { CharizardVmax } from '../09-sword-and-shield/set-darkness-ablaze/charizard-vmax';
import { CentiskorchV } from '../09-sword-and-shield/set-darkness-ablaze/centiskorch-v';
import { CentiskorchVmax } from '../09-sword-and-shield/set-darkness-ablaze/centiskorch-vmax';
import { LaprasV } from '../09-sword-and-shield/set-sword-and-shield/lapras-v';
import { LaprasVmax } from '../09-sword-and-shield/set-sword-and-shield/lapras-vmax';
import { ToxtricityV } from '../09-sword-and-shield/set-rebel-clash/toxtricity-v';
import { ToxtricityVmax } from '../09-sword-and-shield/set-rebel-clash/toxtricity-vmax';
import { GrimmsnarlV } from '../09-sword-and-shield/set-darkness-ablaze/grimmsnarl-v';
import { GrimmsnarlVmax } from '../09-sword-and-shield/set-darkness-ablaze/grimmsnarl-vmax';
import { Dartrix } from './dartrix';
import { Decidueye } from '../09-sword-and-shield/set-darkness-ablaze/decidueye';
import { DhelmiseV } from '../09-sword-and-shield/set-sword-and-shield/dhelmise-v';
import { Thwackey } from './thwackey';
import { Rillaboom } from '../09-sword-and-shield/set-sword-and-shield/rillaboom';
import { CinderaceVmax } from '../09-sword-and-shield/set-rebel-clash/cinderace-vmax';
import { Snom } from './snom';
import { Shinx } from '../09-sword-and-shield/set-rebel-clash/shinx';
import { Luxray } from '../09-sword-and-shield/set-rebel-clash/luxray';
import { Rotom } from './rotom';
import { Morpeko2 } from './morpeko-2';
import { MorpekoV } from '../09-sword-and-shield/set-sword-and-shield/morpeko-v';
import { MorpekoVmax } from '../09-sword-and-shield/set-sword-and-shield/morpeko-vmax';
import { IndeedeeV } from '../09-sword-and-shield/set-sword-and-shield/indeedee-v';
import { Trapinch } from '../09-sword-and-shield/set-darkness-ablaze/trapinch';
import { Koffing } from './koffing';
import { GalarianWeezing } from './galarian-weezing';
import { Cufant } from '../09-sword-and-shield/set-darkness-ablaze/cufant';
import { DittoV } from './ditto-v';
import { DittoVmax } from './ditto-vmax';
import { CramorantV } from '../09-sword-and-shield/set-sword-and-shield/cramorant-v';
...
import { AlcremieV } from '../09-sword-and-shield/set-champions-path/alcremie-v';
import { BallGuy } from './ball-guy';
import { CaraLiss } from '../09-sword-and-shield/set-vivid-voltage/cara-liss';
...
import { Hatterene } from '../09-sword-and-shield/set-rebel-clash/hatterene';
import { Grimmsnarl } from '../09-sword-and-shield/set-rebel-clash/grimmsnarl';
import { Oranguru } from '../09-sword-and-shield/set-sword-and-shield/oranguru';
import { GalarianStunfisk } from '../09-sword-and-shield/set-sword-and-shield/galarian-stunfisk';
import { Inteleon } from '../09-sword-and-shield/set-sword-and-shield/inteleon';
import { Luxio } from '../09-sword-and-shield/set-rebel-clash/luxio';
import { EternatusV } from '../09-sword-and-shield/set-darkness-ablaze/eternatus-v';
import { EternatusVMAX } from '../09-sword-and-shield/set-darkness-ablaze/eternatus-vmax';
import { CrobatV } from '../09-sword-and-shield/set-darkness-ablaze/crobat-v';
import { Coalossal } from '../09-sword-and-shield/set-rebel-clash/coalossal';
import { CinderaceV } from '../09-sword-and-shield/set-rebel-clash/cinderace-v';
import { Cinderace } from '../09-sword-and-shield/set-sword-and-shield/cinderace';
import { GalarianObstagoon } from '../09-sword-and-shield/set-sword-and-shield/galarian-obstagoon';
import { Appletun } from '../09-sword-and-shield/set-rebel-clash/appletun';
import { GalarianZigzagoon } from '../09-sword-and-shield/set-sword-and-shield/galarian-zigzagoon';
import { GalarianMeowth } from '../09-sword-and-shield/set-rebel-clash/galarian-meowth';
import { GalarianRapidash } from '../09-sword-and-shield/set-sword-and-shield/galarian-rapidash';
import { Flapple } from '../09-sword-and-shield/set-rebel-clash/flapple';
import { Dracovish } from '../09-sword-and-shield/set-darkness-ablaze/dracovish';
import { Arctozolt } from '../09-sword-and-shield/set-darkness-ablaze/arctozolt';
import { GalarianCursola } from '../09-sword-and-shield/set-rebel-clash/galarian-cursola';
import { GalarianPerrserker } from '../09-sword-and-shield/set-sword-and-shield/galarian-perrserker';
import { GalarianMrRime } from '../09-sword-and-shield/set-darkness-ablaze/galarian-mr-rime';
import { Centiskorch } from '../09-sword-and-shield/set-sword-and-shield/centiskorch';
import { Barraskewda } from '../09-sword-and-shield/set-rebel-clash/barraskewda';
import { FalinksV } from '../09-sword-and-shield/set-rebel-clash/falinks-v';
import { Dragapult } from '../09-sword-and-shield/set-rebel-clash/dragapult';
import { Eiscue } from '../09-sword-and-shield/set-rebel-clash/eiscue';
import { DubwoolV } from '../09-sword-and-shield/set-rebel-clash/dubwool-v';
import { Copperajah } from '../09-sword-and-shield/set-darkness-ablaze/copperajah';
import { Blipbug } from '../09-sword-and-shield/set-sword-and-shield/blipbug';
import { Chewtle } from '../09-sword-and-shield/set-sword-and-shield/chewtle';
import { Drizzile } from '../09-sword-and-shield/set-sword-and-shield/drizzile';
import { Sobble3 } from '../09-sword-and-shield/set-sword-and-shield/sobble-3';
import { Applin2 } from '../09-sword-and-shield/set-rebel-clash/applin-2';
import { Gossifleur } from '../09-sword-and-shield/set-sword-and-shield/gossifleur';
import { Raboot } from '../09-sword-and-shield/set-sword-and-shield/raboot';
import { Sizzlipede } from '../09-sword-and-shield/set-sword-and-shield/sizzlipede';
import { GalarianMrMime } from '../09-sword-and-shield/set-darkness-ablaze/galarian-mr-mime';
import { Arrokuda } from '../09-sword-and-shield/set-rebel-clash/arrokuda';
import { Toxel } from '../09-sword-and-shield/set-darkness-ablaze/toxel';
import { Sinistea } from '../09-sword-and-shield/set-darkness-ablaze/sinistea';
import { Rolycoly } from '../09-sword-and-shield/set-rebel-clash/rolycoly';
import { Carkol } from '../09-sword-and-shield/set-rebel-clash/carkol';
import { Falinks } from '../09-sword-and-shield/set-rebel-clash/falinks';
import { Impidimp } from '../09-sword-and-shield/set-rebel-clash/impidimp';
