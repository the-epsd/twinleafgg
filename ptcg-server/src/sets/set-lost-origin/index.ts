...
import { GalladeV } from './gallade-v';
...
import { HisuianGoodra } from './hisuian-goodra';
...
import { HisuianSliggoo } from './hisuian-sliggoo';
...
import { RadiantSteelix } from './radiant-steelix';
...
import { ArcPhone } from './arc-phone';
import { Arezu } from './arezu';
import { BoxOfDisaster } from './box-of-disaster';
import { ColresssExperiment } from './colresss-experiment';
...
import { WindupArm } from './windup-arm';
...
import {
  ...
  RotomV3LOR,
  DrapionV2LOR,
  GalarianPerrserkerV2LOR,
  GalarianPerrserkerV3LOR,
  GiratinaV2LOR,
  GiratinaV3LOR,
  HisuianGoodraV2LOR,
  PidgeotV2LOR,
  Arezu2LOR,
  ColresssExperiment2LOR,
  LadyFLI2LOR,
  MissFortuneSisters2LOR,
  Thorton2LOR,
  Volo2LOR,
  KyuremVMAX2LOR,
  MagnezoneVSTAR2LOR,
  DrapionVSTAR2LOR,
  GiratinaVSTAR2LOR,
  HisuianGoodraVSTAR2LOR,
  HisuianZoroarkVSTAR2LOR,
  Arezu3LOR,
  ColresssExperiment3LOR,
  LadyFLI3LOR,
  MissFortuneSisters3LOR,
  Thorton3LOR,
  Volo3LOR,
  GiratinaVSTAR3LOR,
  HisuianZoroarkVSTAR3LOR,
  BoxOfDisaster2LOR,
  CollapsedStadiumLOR,
  DarkPatchLOR,
  LostVacuum2LOR,
...
export const setLostOrigin: Card[] = [
  ...
  new MurkrowLOR(),
  new GoomyLOR(),
  new HisuianElectrodeVLOR(),
  new EnamorusV2(),
  new AerodactylV2(),
  new AerodactylV3(),
  new Fantina2(),
  new Iscan2(),
  new AerodactylVstar2(),
  new Fantina3(),
  new Iscan3(),
];
