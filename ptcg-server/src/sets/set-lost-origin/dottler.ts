...
export class Dottler extends PokemonCard {
  ...
  public readonly REDUCE_DAMAGE_MARKER = 'DOTTLER_LOR_REDUCE_DAMAGE_MARKER';
  public readonly CLEAR_REDUCE_DAMAGE_MARKER = 'DOTTLER_LOR_CLEAR_REDUCE_DAMAGE_MARKER';
