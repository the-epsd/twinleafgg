...
export class UmbreonUD extends Umbreon {
  ...
  public legacyFullName = 'Umbreon UD';
  public set = 'UD';
}

export class DefenderUD extends Defender {
  public setNumber = '72';
  public fullName: string = 'Defender (UD 72)';
  public legacyFullName = 'Defender UD';
  public set = 'UD';
}

export class SagesTrainingUD extends SagesTraining {
  public setNumber = '77';
  public fullName: string = 'Sage\'s Training (UD 77)';
  public legacyFullName = 'Sage\'s Training UD';
  public set = 'UD';
}
