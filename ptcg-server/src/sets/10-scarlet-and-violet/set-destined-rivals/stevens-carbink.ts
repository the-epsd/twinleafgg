...
export class StevensCarbink extends PokemonCard {
  ...
  public powers = [
    {
      ...
      text:
        "As long as this Pokémon is on the Bench, all of your Steven's Pokémon take 30 less damage " +
  ...
  public reduceEffect(store: StoreLike, state: State, effect: Effect): State {
    if (
      ...
      StateUtils.isPokemonInPlay(effect.player, this, SlotType.BENCH)
    ) {
      ...
      if (effect.target.getPokemonCard()?.hasTag(CardTag.STEVENS)) {
