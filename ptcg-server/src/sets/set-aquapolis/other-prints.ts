...
export class PokemonFanClubAQ extends PokemonFanClub {
  public fullName = 'Pokémon Fan Club (AQ 130)';
  public legacyFullName = 'Pokemon Fan Club AQ';
  public set = 'AQ';
...
export class RainbowEnergyAQ extends RainbowEnergy {
  public fullName = 'Rainbow Energy (AQ 144)';
  public legacyFullName = 'Rainbow Energy AQ';
  public set = 'AQ';
...
export class WarpEnergyAQ extends WarpEnergy {
  public fullName = 'Warp Energy (AQ 147)';
  public legacyFullName = 'Warp Energy AQ';
  public set = 'AQ';
