...
export class SurvivalCast extends TrainerCard {
  ...
  public text: string =
    'If the Pokémon this card is attached to has full HP and would be KOd by damage from an attack, it is not KOd and its remaining HP becomes 10 instead. Then, discard this card.';
