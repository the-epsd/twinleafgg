...
import { ArctibaxArt, ArtazonArt, CetitanArt, ChiYuexArt, GiacomoArt, GrushaArt, NoibatArt, NoivernexArt, TinkatinkArt, TinkatonArt, TinkatuffArt, WingullArt } from './card-images';
