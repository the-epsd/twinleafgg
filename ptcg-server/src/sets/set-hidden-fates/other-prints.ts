import { Slowpoke } from '../08-sun-and-moon/set-lost-thunder/slowpoke';
import { BillsAnalysis } from '../08-sun-and-moon/set-team-up/bills-analysis';
import { LtSurgesStrategy } from '../08-sun-and-moon/set-unbroken-bonds/lt-surges-strategy';
import { MoltresZapdosArticunoGX as MoltresZapdosArticunoGXHIF44 } from '../set-hidden-fates/moltres-zapdos-articuno-gx';
import { Rowlet } from '../08-sun-and-moon/set-sun-and-moon/rowlet';
import { Dartrix } from '../08-sun-and-moon/set-sun-and-moon/dartrix';
import { FroakieFrubbles } from '../08-sun-and-moon/set-forbidden-light/froakie-2';
import { Frogadier } from '../08-sun-and-moon/set-forbidden-light/frogadier';
import { Shuppet } from '../08-sun-and-moon/set-celestial-storm/shuppet';
import { Inkay } from '../08-sun-and-moon/set-forbidden-light/inkay';
import { Malamar } from '../08-sun-and-moon/set-forbidden-light/malamar';
import { Poipole } from '../08-sun-and-moon/set-forbidden-light/poipole';
import { Sudowoodo } from '../08-sun-and-moon/set-guardians-rising/sudowoodo';
import { Riolu } from '../08-sun-and-moon/set-ultra-prism/riolu';
import { Lucario } from '../08-sun-and-moon/set-ultra-prism/lucario';
import { Rockruff } from '../08-sun-and-moon/set-forbidden-light/rockruff';
import { Buzzwole } from '../08-sun-and-moon/set-forbidden-light/buzzwole';
import { Zorua } from '../set-shining-legends/zorua';
import { Magnezone } from '../08-sun-and-moon/set-ultra-prism/magnezone';
import { Ralts } from '../08-sun-and-moon/set-burning-shadows/ralts';
import { Diancie } from '../08-sun-and-moon/set-burning-shadows/diancie';
import { Gible } from '../08-sun-and-moon/set-ultra-prism/gible';
import { Gabite } from '../08-sun-and-moon/set-ultra-prism/gabite';
import { Garchomp } from '../08-sun-and-moon/set-ultra-prism/garchomp';
import { Eevee as EeveeSUM101 } from '../08-sun-and-moon/set-sun-and-moon/eevee';
import { Noibat } from '../08-sun-and-moon/set-burning-shadows/noibat';
import { Oranguru } from '../08-sun-and-moon/set-sun-and-moon/oranguru';
import { DecidueyeGX } from '../08-sun-and-moon/set-sun-and-moon/decidueye-gx';
import { AlolanNinetalesGX } from '../08-sun-and-moon/set-guardians-rising/alolan-ninetales-gx';
import { ArticunoGX } from '../08-sun-and-moon/set-celestial-storm/articuno-gx';
import { GlaceonGX } from '../08-sun-and-moon/set-ultra-prism/glaceon-gx';
import { GreninjaGX } from '../08-sun-and-moon/set-forbidden-light/greninja-gx';
import { ElectrodeGX } from '../08-sun-and-moon/set-celestial-storm/electrode-gx';
import { MewtwoGX as MewtwoGXSLG39 } from '../set-shining-legends/mewtwo-gx';
import { EspeonGX } from '../08-sun-and-moon/set-sun-and-moon/espeon-gx';
import { BanetteGX } from '../08-sun-and-moon/set-celestial-storm/banette-gx';
import { NaganadelGX } from '../08-sun-and-moon/set-forbidden-light/naganadel-gx';
import { LucarioGX } from '../08-sun-and-moon/set-sun-and-moon-promos/lucario-gx';
import { LycanrocGX } from '../08-sun-and-moon/set-guardians-rising/lycanroc-gx';
import { BuzzwoleGX } from '../08-sun-and-moon/set-crimson-invasion/buzzwole-gx';
import { DarkraiGX } from '../08-sun-and-moon/set-burning-shadows/darkrai-gx';
import { GuzzlordGX } from '../08-sun-and-moon/set-crimson-invasion/guzzlord-gx';
import { KartanaGX } from '../08-sun-and-moon/set-crimson-invasion/kartana-gx';
import { GardevoirGX } from '../08-sun-and-moon/set-burning-shadows/gardevoir-gx';
import { SylveonGX } from '../08-sun-and-moon/set-guardians-rising/sylveon-gx';
import { NoivernGX } from '../08-sun-and-moon/set-burning-shadows/noivern-gx';
...
import { MtCoronet } from '../08-sun-and-moon/set-ultra-prism/mt-coronet';
import { ShrineOfPunishment } from '../08-sun-and-moon/set-celestial-storm/shrine-of-punishment';
import { TapuBuluGX } from '../08-sun-and-moon/set-burning-shadows/tapu-bulu-gx';
...
import { Pheromosa } from '../08-sun-and-moon/set-forbidden-light/pheromosa';
import { Xurkitree } from '../08-sun-and-moon/set-forbidden-light/xurkitree';
import { Guzzlord } from '../08-sun-and-moon/set-forbidden-light/guzzlord';
import { Magnemite } from '../08-sun-and-moon/set-forbidden-light/magnemite';
import { Magneton } from '../08-sun-and-moon/set-ultra-prism/magneton';
import { Beldum } from '../08-sun-and-moon/set-guardians-rising/beldum';
import { Metang } from '../08-sun-and-moon/set-guardians-rising/metang';
import { Celesteela } from '../08-sun-and-moon/set-celestial-storm/celesteela';
import { Kartana } from '../08-sun-and-moon/set-celestial-storm/kartana';
import { Swablu } from '../set-dragons-majesty/swablu';
import { TypeNull } from '../08-sun-and-moon/set-crimson-invasion/type-null';
import { GolisopodGx } from '../08-sun-and-moon/set-burning-shadows/golisopod-gx';
import { TurtonatorGx } from '../08-sun-and-moon/set-guardians-rising/turtonator-gx';
import { ZygardeGx } from '../08-sun-and-moon/set-forbidden-light/zygarde-gx';
import { UmbreonGx } from '../08-sun-and-moon/set-sun-and-moon/umbreon-gx';
import { AetherFoundationEmployee } from '../08-sun-and-moon/set-lost-thunder/aether-foundation-employee';
