...
export class CaptureEnergyArt extends CaptureEnergy {
...
export class ScoopUpNetArt extends ScoopUpNet {
  public cardImage = 'https://limitlesstcg.nyc3.digitaloceanspaces.com/tpci/RCL/RCL_165_R_EN_LG.png';
}

export class SpeedLightningEnergyArt extends SpeedLightningEnergy {
  public cardImage = 'https://limitlesstcg.nyc3.digitaloceanspaces.com/tpci/RCL/RCL_173_R_EN_LG.png';
}

export class TrainingCourtArt extends TrainingCourt {
  public cardImage = 'https://limitlesstcg.nyc3.digitaloceanspaces.com/tpci/RCL/RCL_169_R_EN_LG.png';
}
