...
import { COIN_FLIP_PROMPT, ADD_PARALYZED_TO_PLAYER_ACTIVE, ABILITY_USED, SEARCH_YOUR_DECK_FOR_POKEMON_AND_PUT_INTO_HAND, WAS_ATTACK_USED } from '../../game/store/prefabs/prefabs';
...
export class ErikasTangela extends PokemonCard {
  ...
  public fullName: string = 'Erika\'s Tangela M2a';
