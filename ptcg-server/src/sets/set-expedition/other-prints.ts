...
export class CopycatEX extends Copycat {
  public fullName = 'Copycat (EX 138)';
  public legacyFullName = 'Copycat EX';
  public set = 'EX';
...
export class DualBallEX extends DualBall {
  public fullName = 'Dual Ball (EX 139)';
  public legacyFullName = 'Dual Ball EX';
  public set = 'EX';
...
export class EnergyRemoval2EX extends EnergyRemoval2 {
  public fullName = 'Energy Removal 2 (EX 140)';
  public legacyFullName = 'Energy Removal 2 EX';
  public set = 'EX';
...
export class EnergySearchEX extends EnergySearch {
  public fullName = 'Energy Search (EX 153)';
  public legacyFullName = 'Energy Search EX';
  public set = 'EX';
...
export class PokemonReversalEX extends PokemonReversal {
  public fullName = 'Pokemon Reversal (EX 146)';
  public legacyFullName = 'Pokémon Reversal EX';
  public set = 'EX';
...
export class ProfessorElmsTrainingMethodEX extends ProfessorElmsTrainingMethod {
  public fullName = 'Professor Elm\'s Training Method (EX 148)';
  public legacyFullName = 'Professor Elm\'s Training Method EX';
  public set = 'EX';
...
export class ProfessorOaksResearchEX extends ProfessorOaksResearch {
  public fullName = 'Professor Oak\'s Research (EX 149)';
  public legacyFullName = 'Professor Oak\'s Research EX';
  public set = 'EX';
...
export class StrengthCharmEX extends StrengthCharm {
  public fullName = 'Strength Charm (EX 150)';
  public legacyFullName = 'Strength Charm EX';
  public set = 'EX';
...
export class SwitchEX extends Switch {
  public fullName = 'Switch (EX 157)';
  public legacyFullName = 'Switch EX';
  public set = 'EX';
