import { ADD_POISON_TO_PLAYER_ACTIVE, AFTER_ATTACK, SEARCH_YOUR_DECK_FOR_POKEMON_AND_PUT_ONTO_BENCH, WAS_ATTACK_USED } from '../../game/store/prefabs/prefabs';
...
export class Trubbish extends PokemonCard {
  ...
  public fullName: string = 'Trubbish FST';
