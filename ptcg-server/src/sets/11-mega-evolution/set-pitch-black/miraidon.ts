  ...
  public powers = [
    {
      ...
      text: "If this Pokémon is in the Active Spot and is Knocked Out by damage from an attack from your opponent's Pokémon, move up to 2 Basic [L] Energy cards from this Pokémon to 1 of your Benched Pokémon.",
    },
  ];
