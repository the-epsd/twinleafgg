...
export class Jynx extends PokemonCard {
  ...
  public readonly WICKED_MARKER = 'M5_JYNX_WICKED';
  public readonly CLEAR_WICKED_MARKER = 'M5_JYNX_CLEAR_WICKED';
  ...
  public reduceEffect(store: StoreLike, state: State, effect: Effect): State {
    ...
    if (effect instanceof EndTurnEffect && effect.player.marker.hasMarker(this.CLEAR_WICKED_MARKER, this)) {
