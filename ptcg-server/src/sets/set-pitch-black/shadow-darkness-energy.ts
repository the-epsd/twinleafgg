...
export class ShadowDarknessEnergy extends EnergyCard {
  ...
  public name = 'Shadow Darkness Energy';
  public fullName: string = 'Shadow Darkness Energy M5';

  public text = `As long as this card is attached to a Pokémon, it provides [D] Energy.
