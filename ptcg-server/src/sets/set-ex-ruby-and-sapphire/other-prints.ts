...
export class EnergySwitchRS extends EnergySwitch {
  ...
  public setNumber = '82';
  public fullName = 'Energy Switch (RS 82)';
  public legacyFullName = 'Energy Switch RS';
...
export class EnergyRemoval2RS extends EnergyRemoval2 {
  public set = 'RS';
  public setNumber = '80';
  public fullName = 'Energy Removal 2 (RS 80)';
  public legacyFullName = 'Energy Removal 2 RS';
}

export class MetalEnergySpecialRS extends MetalEnergySpecial {
  public set = 'RS';
  public setNumber = '94';
  public fullName = 'Metal Energy (RS 94)';
  public legacyFullName = 'Metal Energy RS';
...
export class RainbowEnergyRS extends RainbowEnergy {
  public set = 'RS';
  public setNumber = '95';
  public fullName = 'Rainbow Energy (RS 95)';
  public legacyFullName = 'Rainbow Energy RS';
...
export class SwitchRS extends Switch {
  public set = 'RS';
  public setNumber = '92';
  public fullName = 'Switch (RS 92)';
  public legacyFullName = 'Switch RS';
