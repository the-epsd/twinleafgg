...
export declare enum GameLog {
    ...
    LOG_ABILITY_BLOCKS_DAMGE = "LOG_ABILITY_BLOCKS_DAMAGE",
...
export declare const GameMessage: {
    ...
    SHUFFLE_AND_DRAW_5_CARDS: GameCardMessage.SHUFFLE_AND_DRAW_5_CARDS;
    ...
    LABEL_VSTAR_USED: GameStoreMessage.LABEL_VSTAR_USED;
