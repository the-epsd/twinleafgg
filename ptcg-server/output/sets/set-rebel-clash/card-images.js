...
class ButterfreeArt extends butterfree_1.Butterfree {
    constructor() {
        super(...arguments);
        this.cardImage = 'https://limitlesstcg.nyc3.digitaloceanspaces.com/tpci/RCL/RCL_003_R_EN_LG.png';
    }
}
...
class CaterpieArt extends caterpie_1.Caterpie {
    constructor() {
        super(...arguments);
        this.cardImage = 'https://limitlesstcg.nyc3.digitaloceanspaces.com/tpci/RCL/RCL_001_R_EN_LG.png';
    }
}
...
class MetapodArt extends metapod_1.Metapod {
    constructor() {
        super(...arguments);
        this.cardImage = 'https://limitlesstcg.nyc3.digitaloceanspaces.com/tpci/RCL/RCL_002_R_EN_LG.png';
    }
}
...
class NatuArt extends natu_1.Natu {
    constructor() {
        super(...arguments);
        this.cardImage = 'https://limitlesstcg.nyc3.digitaloceanspaces.com/tpci/RCL/RCL_076_R_EN_LG.png';
    }
}
