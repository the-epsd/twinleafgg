...
const wide_lens_1 = require("./wide_lens");
...
class DustoxArt extends dustox_1.Dustox {
    constructor() {
        super(...arguments);
...
class SwellowArt extends swellow_1.Swellow {
    constructor() {
        super(...arguments);
...
class WideLensArt extends wide_lens_1.WideLens {
    constructor() {
        super(...arguments);
