...
const m_rayquaza_ex_1 = require("./m-rayquaza-ex");
...
const ROS_95_Wide_Lens_1 = require("./ROS_95_Wide_Lens");
...
class DustoxArt extends ROS_8_Dustox_1.Dustox {
    constructor() {
        super(...arguments);
        this.cardImage = 'https://limitlesstcg.nyc3.digitaloceanspaces.com/tpci/ROS/ROS_008_R_EN_LG.png';
    }
}
exports.DustoxArt = DustoxArt;
class MRayquazaEXArt extends m_rayquaza_ex_1.MRayquazaEX {
    constructor() {
        super(...arguments);
        this.cardImage = 'https://limitlesstcg.nyc3.digitaloceanspaces.com/tpci/ROS/ROS_061_R_EN.png';
    }
}
exports.MRayquazaEXArt = MRayquazaEXArt;
...
class SwellowArt extends ROS_72_Swellow_1.Swellow {
    constructor() {
        super(...arguments);
        this.cardImage = 'https://limitlesstcg.nyc3.digitaloceanspaces.com/tpci/ROS/ROS_072_R_EN_LG.png';
    }
}
exports.SwellowArt = SwellowArt;
...
class VoltorbArt extends ROS_21_Voltorb_1.Voltorb {
    constructor() {
        super(...arguments);
        this.cardImage = 'https://limitlesstcg.nyc3.digitaloceanspaces.com/tpci/ROS/ROS_021_R_EN_LG.png';
    }
}
...
class WideLensArt extends ROS_95_Wide_Lens_1.WideLens {
    constructor() {
        super(...arguments);
        this.cardImage = 'https://limitlesstcg.nyc3.digitaloceanspaces.com/tpci/ROS/ROS_095_R_EN_LG.png';
    }
}
exports.WideLensArt = WideLensArt;
