...
exports.setParadoxRift = [
    ...
    new full_art_1.IronMothIR(),
    new full_art_1.SnoruntIR(),
    new full_art_1.VanillishIR(),
    new full_art_1.BlitzleIR(),
    new full_art_1.JoltikIR(),
    ...
    new full_art_1.YveltalIR(),
    new full_art_1.MorpekoIR(),
    new full_art_1.BruteBonnetIR(),
    new full_art_1.FerrothorIR(),
    new full_art_1.AegislashIR(),
    new full_art_1.SwabluIR(),
    new full_art_1.PorygonZIR(),
