...
function* playCard(next, store, state, effect) {
    ...
    yield store.prompt(state, new choose_cards_prompt_1.ChooseCardsPrompt(player.id, game_message_1.GameMessage.CHOOSE_CARD_TO_DISCARD, player.deck, {}, { min: 1, max: 5, allowCancel: false }), selected => {
        cards = selected || [];
        next();
    });
...
class PerfectMixer extends trainer_card_1.TrainerCard {
    constructor() {
        super(...arguments);
...
exports.PerfectMixer = PerfectMixer;
