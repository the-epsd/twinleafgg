...
class GalarianLinooneArt extends galarian_linoone_1.GalarianLinoone {
    constructor() {
        super(...arguments);
        this.cardImage = 'https://limitlesstcg.nyc3.digitaloceanspaces.com/tpci/FST/FST_160_R_EN.png';
    }
}
exports.GalarianLinooneArt = GalarianLinooneArt;
...
class HeatmorArt extends heatmor_1.Heatmor {
    constructor() {
        super(...arguments);
        this.cardImage = 'https://limitlesstcg.nyc3.digitaloceanspaces.com/tpci/FST/FST_041_R_EN_LG.png';
    }
}
exports.HeatmorArt = HeatmorArt;
...
class ShellderArt extends shellder_1.Shellder {
    constructor() {
        super(...arguments);
        this.cardImage = 'https://limitlesstcg.nyc3.digitaloceanspaces.com/tpci/FST/FST_050_R_EN_LG.png';
    }
}
...
class TotodileArt extends totodile_1.Totodile {
    constructor() {
        super(...arguments);
        this.cardImage = 'https://limitlesstcg.nyc3.digitaloceanspaces.com/tpci/FST/FST_055_R_EN_LG.png';
    }
}
