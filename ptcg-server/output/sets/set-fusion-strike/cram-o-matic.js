...
function* playCard(next, store, state, effect) {
    ...
    yield store.prompt(state, new choose_cards_prompt_1.ChooseCardsPrompt(player.id, game_message_1.GameMessage.CHOOSE_CARD_TO_DISCARD, handTemp, {}, { min: 0, max: 1, allowCancel: false }), selected => {
        cards = selected || [];
        next();
    });
