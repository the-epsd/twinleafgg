...
function* useStadium(next, store, state, effect) {
    ...
    player.discard.cards.forEach((c, index) => {
        const isPokemon = c instanceof game_1.EnergyCard && c.energyType === card_types_1.EnergyType.BASIC && c.name === 'Metal Energy';
        if (isPokemon) {
...
class MtCoronet extends trainer_card_1.TrainerCard {
    constructor() {
        super(...arguments);
