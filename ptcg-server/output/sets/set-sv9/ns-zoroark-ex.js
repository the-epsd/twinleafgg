...
function* useNightJoker(next, store, state, effect) {
    ...
    const benched = player.bench.filter(b => { var _a; return b.cards.length > 0 && ((_a = b.getPokemonCard()) === null || _a === void 0 ? void 0 : _a.tags.includes(card_types_1.CardTag.NS)) && player.active !== b; });
