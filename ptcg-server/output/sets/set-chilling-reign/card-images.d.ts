...
export declare class GalarianArticunoVArt extends GalarianArticunoV {
    cardImage: string;
}
...
export declare class JustifiedGlovesArt extends JustifiedGloves {
    cardImage: string;
}
export declare class KarensConvictionArt extends KarensConviction {
    cardImage: string;
}
