...
class BrambleghastArt extends brambleghast_1.Brambleghast {
    constructor() {
        super(...arguments);
        this.cardImage = 'https://limitlesstcg.nyc3.digitaloceanspaces.com/tpci/TEF/TEF_021_R_EN_LG.png';
    }
}
exports.BrambleghastArt = BrambleghastArt;
...
class GrubbinArt extends grubbin_1.Grubbin {
    constructor() {
        super(...arguments);
        this.cardImage = 'https://limitlesstcg.nyc3.digitaloceanspaces.com/tpci/TEF/TEF_018_R_EN.png';
    }
}
exports.GrubbinArt = GrubbinArt;
