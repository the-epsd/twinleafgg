...
class ViridianForest extends trainer_card_1.TrainerCard {
    constructor() {
        super(...arguments);
        this.trainerType = card_types_1.TrainerType.STADIUM;
        this.set = 'TEU';
        this.name = 'Viridian Forest';
        this.fullName = 'Viridian Forest TEU';
...
exports.ViridianForest = ViridianForest;
