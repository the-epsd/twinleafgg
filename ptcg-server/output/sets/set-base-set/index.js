...
exports.setBaseSet = [
    ...
    new clefairy_doll_1.ClefairyDoll(),
    new computer_search_1.ComputerSearch(),
    new defender_1.Defender(),
    ...
    new pokemon_breeder_1.PokemonBreeder(),
    new pokemon_center_1.PokemonCenter(),
    new pokemon_flute_1.PokemonFlute(),
    new pokemon_trader_1.PokemonTrader(),
