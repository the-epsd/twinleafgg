...
class Md5 {
    ...
    static ConvertToWordArray(str) {
        const lMessageLength = str.length, lNumberOfWordsTemp1 = lMessageLength + 8, lNumberOfWordsTemp2 = (lNumberOfWordsTemp1 - (lNumberOfWordsTemp1 % 64)) / 64, lNumberOfWords = (lNumberOfWordsTemp2 + 1) * 16, lWordArray = Array(lNumberOfWords - 1);
        let lWordCount, lBytePosition = 0, lByteCount = 0;
